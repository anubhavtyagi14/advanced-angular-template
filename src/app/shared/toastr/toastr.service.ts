...
export class ToastrService implements OnDestroy {
  ...
  // public queueSnackBar(message: string, action?: string) {
  //   this.snackBarQueue.next(
  //     this.snackBarQueue.value.concat([{ message, action, beingDispatched: false }]),
  //   );
  // }
  ...
  success(message: string, action?: string) {
    ...
    //   panelClass: [Toastr, ToastrType.success],
    //   data: {
    //     title: 'Success',
    //     message
    //   } as ToastrOptions
